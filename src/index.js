 ...
 const languageString = {
     'en': {
         'translation': {
             ...
             'GAME_NAME': 'Seattle Trivia', // Be sure to change this for your skill.
     ...
     'en-US': {
         'translation': {
             'QUESTIONS': questions['QUESTIONS_EN_US'],
             'GAME_NAME': 'American Seattle Trivia', // Be sure to change this for your skill.
         },
     },
     'en-GB': {
         'translation': {
             'QUESTIONS': questions['QUESTIONS_EN_GB'],
             'GAME_NAME': 'British Seattle Trivia', // Be sure to change this for your skill.
         },
     },
 };
